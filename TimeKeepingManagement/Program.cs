...
class Program
{
    static TimeKeepingService _service = new TimeKeepingService(new TimeDBData());
    ...
    static void EmployeeRegistration()
    {
        ...
        // Check if employee already exists using service
    ...
    static void TimeInAndTimeOut()
    {
        ...
        Console.WriteLine($"\nWelcome, {_service.GetEmployeeNames()[employeeIndex]}! Your shift is: {_service.GetEmployeeShifts()[employeeIndex]}\n");
